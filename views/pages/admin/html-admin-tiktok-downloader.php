...
if (isset($_POST) && !empty($_POST) && !empty($_POST['njt-tk-settings-form-submit'])) {
    ...
    $this->titokSetting['text_shortcode'] = filter_var($_POST['njt-tk-text-shortcode'], FILTER_SANITIZE_STRING) ? sanitize_text_field($_POST['njt-tk-text-shortcode']) : '';
...
<div class="njt-tk-admin-setting">
  <div class="njt-tk-admin-content">
    <div class="wrap">
      <h2><?php _e("Settings", NJT_TK_BN_DOMAIN);?></h2>
    </div>
    <form action="" class="njt-tk-plugin-setting settings-form" method="POST">
      ...
      <table class="form-table">
        <tr>
          <th><?php _e("Shortcode", NJT_TK_BN_DOMAIN);?></th>
          <td>
        ...
        <tr>
          <th><?php _e("Text heading", NJT_TK_BN_DOMAIN);?></th>
          <td>
        ...
        <tr>
          <th><?php _e("Text description", NJT_TK_BN_DOMAIN);?></th>
          <td>
        ...
        <tr>
          <th><?php _e("Text example", NJT_TK_BN_DOMAIN);?></th>
          <td>
